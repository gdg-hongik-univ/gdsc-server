...
public enum ErrorCode {
    ...
    UNIV_EMAIL_VERIFICATION_CODE_NOT_SENT(BAD_REQUEST, "재학생 인증 메일이 발송되지 않았습니다."),
    EMAIL_VERIFICATION_CODE_NOT_SENT(BAD_REQUEST, "본인 인증 메일이 발송되지 않았습니다."),
    ...
    // Event
    EVENT_NOT_FOUND(NOT_FOUND, "존재하지 않는 행사입니다."),
    EVENT_NOT_APPLICABLE_NOT_REGULAR_ROLE(CONFLICT, "정회원이 아닌 회원은 행사에 신청할 수 없습니다."),
    EVENT_NOT_APPLICABLE_APPLICATION_PERIOD_INVALID(CONFLICT, "행사 신청 기간이 아닙니다."),
    EVENT_NOT_APPLICABLE_AFTER_PARTY_NONE(CONFLICT, "뒤풀이가 활성화된 행사는 뒤풀이 신청 여부를 NONE으로 설정할 수 없습니다."),
    EVENT_NOT_APPLICABLE_AFTER_PARTY_DISABLED(CONFLICT, "뒤풀이가 비활성화된 행사에 뒤풀이 신청을 할 수 없습니다."),
    EVENT_NOT_APPLICABLE_MEMBER_INFO_NOT_SATISFIED(CONFLICT, "기본 회원정보 작성이 완료되지 않은 회원은 행사에 신청할 수 없습니다."),
    EVENT_NOT_APPLICABLE_MEMBER_INFO_SATISFIED(CONFLICT, "기본 회원정보가 작성된 회원의 학번으로는 비회원 신청을 할 수 없습니다."),
    EVENT_NOT_APPLICABLE_MAIN_EVENT_MAX_APPLICANT_COUNT_EXCEEDED(CONFLICT, "해당 본행사의 최대 신청가능 인원수를 초과했습니다."),
    EVENT_NOT_APPLICABLE_AFTER_PARTY_MAX_APPLICANT_COUNT_EXCEEDED(CONFLICT, "뒤풀이 최대 신청자 수를 초과했습니다."),
    EVENT_NOT_VIEWABLE_OUTSIDE_APPLICATION_PERIOD(CONFLICT, "행사 신청 기간이 아닙니다."),
    ...
    EVENT_NOT_UPDATABLE_ALREADY_EXISTS_APPLICANT(CONFLICT, "이미 신청자가 존재하는 행사는 폼 관련 항목을 수정할 수 없습니다."),
    EVENT_NOT_UPDATABLE_PAYMENT_STATUS_INVALID(CONFLICT, "뒤풀이가 비활성화된 행사는 결제 관련 항목을 활성화할 수 없습니다."),
    PARTICIPATION_NOT_FOUND(NOT_FOUND, "존재하지 않는 행사 참여정보입니다."),
    PARTICIPATION_NOT_READABLE_AFTER_PARTY_DISABLED(BAD_REQUEST, "뒤풀이가 비활성화된 행사의 참여정보는 조회할 수 없습니다."),
    PARTICIPATION_NOT_DELETABLE_INVALID_IDS(BAD_REQUEST, "존재하지 않거나 중복된 참여 정보 ID가 포함되어 있습니다."),
    PARTICIPATION_NOT_UPDATABLE_DIFFERENT_EVENT(CONFLICT, "서로 다른 행사에 대한 참여 정보들을 한번에 수정할 수 없습니다."),
    ...
    PARTICIPANT_ROLE_NOT_CREATABLE_BOTH_EXISTENCE_MISMATCH(
            INTERNAL_SERVER_ERROR, "행사 참여정보의 멤버 ID와 멤버 인자는 둘 다 null이거나 not null이어야 합니다."),
    PARTICIPANT_ROLE_NOT_CREATABLE_BOTH_ID_MISMATCH(INTERNAL_SERVER_ERROR, "행사 참여정보의 멤버 ID와 인자의 멤버 ID가 일치하지 않습니다."),
    PARTICIPATION_DUPLICATE(CONFLICT, "이미 해당 행사에 신청했습니다."),
