...
public class EventDomainService {
    ...
    /**
     * 행사 기본 정보를 변경합니다.
     * @param regularRoleOnlyStatus 정회원 전용 행사 여부. 이미 신청자가 존재하는 경우 변경할 수 없습니다.
    ...
    /**
     * 행사 또는 뒤풀이의 최대 신청자 수를 변경할 때, 현재 신청자 수보다 낮게 설정하는 경우 예외를 발생시킵니다.
     */
     ...
     * @param eventParticipationExists 현재 행사 신청 정보가 존재하는지 유무. EventParticipationRepository 조회 데이터
     */
